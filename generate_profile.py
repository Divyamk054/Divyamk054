...
INFO = [
    ("__header__", "DIVYA M.K", ""),
    ("__rule__", "", ""),

    ("Role", "AI & Full Stack Developer", "val"),
    ("Edu", "Presidency University · B.Tech CSE · 2028", "val"),
    ("Focus", "AI · Full Stack · Computer Vision", "accent"),

    ("__blank__", "", ""),
    ("__section__", "~/skills", ""),

    ("Lang", "Python · Java · JavaScript · SQL", "val"),
("Frontend", "HTML · CSS · React.js", "val"),
("Backend", "Node.js · Express.js · PHP", "val"),
("AI", "YOLOv8 · OpenCV · Streamlit", "val"),
("Tools", "Git · GitHub · VS Code", "val"),
("Database", "MongoDB · MySQL", "val"),

    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),

("VisionGuard", "AI Construction Safety", "warn"),
("Attendance", "Smart Attendance System", "warn"),
("Portfolio", "3D Portfolio", "warn"),
("NVIDIA", "AI GPU Internship", "warn"),

    ("__blank__", "", ""),
    ("__section__", "~/achievements", ""),

    ("Hackathon", "Smart India Hackathon 2025 Participant", "val"),
("Innovation", "Top 12 - Innovation Challenge", "val"),
("Certification", "Google Cloud Skills Boost", "val"),
...
("GitHub", "github.com/Divyamk054", "accent"),
("LinkedIn", "linkedin.com/in/divyamurthy0124", "accent"),
("Mail", "mkdivya054@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">Open to AI Internships • Full Stack • Software Engineer Roles</tspan>'
